...
public class BubbleBuster extends Monster {
	...
	public BubbleBuster(Level level, int x, int y, int width, int height) {
		...
		this.scoreValue = 500;
		this.sprites[0] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/bubble_buster_left.gif"))).getImage();
		this.sprites[1] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/bubble_buster_right.gif"))).getImage();
		this.sprites[2] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/bubble_buster_bubble.gif"))).getImage();
