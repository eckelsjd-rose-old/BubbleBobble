...
public class Bubble extends Projectile {
	...
	public Bubble(Level level, int x, int y, int dir) {
		...
		this.sprites[0] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/bubble.gif"))).getImage();
		this.sprites[1] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/bubble6.png"))).getImage();
		this.sprites[2] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/fruit_bubble.png"))).getImage();
