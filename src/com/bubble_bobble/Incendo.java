...
public class Incendo extends Monster {
	...
	public Incendo(Level level, int x, int y, int width, int height) {
		...
		this.sprites[0] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/incendo_left.gif"))).getImage();
		this.sprites[1] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/incendo_right.gif"))).getImage();
		this.sprites[2] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/incendo_bubble.gif"))).getImage();
