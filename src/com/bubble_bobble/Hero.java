...
public class Hero extends Collidable {
	...
	public Hero(Level level, int x, int y, int width, int height) {
		...
		this.sprites[0] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/hero0.png"))).getImage();
		this.sprites[1] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/hero_left.gif"))).getImage();
		this.sprites[2] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/hero_right.gif"))).getImage();
		this.sprites[3] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/hero_invincible_left.gif"))).getImage();
		this.sprites[4] = (new ImageIcon(getClass().getClassLoader().getResource("sprites/hero_invincible_right.gif"))).getImage();
